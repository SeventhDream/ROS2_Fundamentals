 ...
 * @brief Demonstrates subscribing to string messsages on a ROS 2 topic.
 * 
 * Description: Demonstrates the basics of subscribing to messages within the ROS 2 framework. The core functionality of this subscriber is to display output to the terminal window when a message is received over a topic.
 * 
 * -------
 * Subscription Topics:
 *  String message
